...
//   return (
//     <div className="p-5 max-w-sm space-y-5">

//       <video
//         ref={vidRef}
//         src="https://flutter.github.io/assets-for-api-docs/assets/videos/butterfly.mp4"></video>


//       <Button onClick={goTO}>Video Play</Button>
...
//       <Button onClick={goTO}>Video Play</Button>
//       <Button onClick={pauseVid} >Video Pause</Button>


//     </div>
//   )
// }
// synchronous(loop)  and asynchoronous (set timer) ,api hit garesi promise obj payinxa  
